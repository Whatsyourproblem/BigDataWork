  ...
  setup() {
    const drawSpot = () => {
      ...
      function dataFormatterAQI(obj) {
        // prettier-ignore
        var pList = ['北京', '天津', '河北', '山西', '内蒙古', '辽宁', '吉林', '黑龙江', '上海', '江苏', '浙江', '安徽', '福建', '江西', '山东', '河南', '湖北', '湖南', '广东', '广西', '海南', '重庆', '四川', '贵州', '云南', '西藏', '陕西', '甘肃', '青海', '新疆', '宁夏'];
        var temp;
        for (var year = 2013; year <= 2018; year++) {
          var max = 0;
          var sum = 0;
      ...
      // prettier-ignore
      dataMap.dataNO2 = dataFormatterNO2({
        //max : 4000,
        ...
        2016: [118.29, 128.85, 2207.34, 477.59, 929.6, 1414.9, 980.57, 1154.33, 113.82, 2261.86, 1163.08, 1495.45, 1182.74, 1098.66, 3226.64, 2769.05, 1795.9, 1969.69, 2010.27, 1458.49, 462.19, 606.8, 2240.61, 550.27, 1067.6, 63.88, 789.64, 497.05, 107.4, 127.25, 759.74],
      ...
      // prettier-ignore
      dataMap.dataCO = dataFormatterCO({
        //max : 26600,
      ...
      // prettier-ignore
      dataMap.dataSO2 = dataFormatterSO2({
        //max : 25000,
      ...
      // prettier-ignore
      dataMap.dataO3 = dataFormatterO3({
        //max : 3600,
        2018: [1074.93, 411.46, 918.02, 224.91, 384.76, 876.12, 238.61, 492.1, 1019.68, 2747.89, 1677.13, 634.92, 911.16, 402.51, 1838.14, 987, 634.67, 518.04, 3321.31, 465.68, 208.71, 396.28, 620.62, 160.3, 222.31, 17.44, 398.03, 134.25, 29.05, 79.01, 176.22],
      ...
      // prettier-ignore
      dataMap.dataPM2 = dataFormatterPM2({
        //max : 3200,
      ...
      dataMap.dataPM10 = dataFormatterPM10({
        //max : 3200,
        2018: [2215.41, 756.5, 746.01, 519.32, 447.46, 755.57, 207.65, 370.78, 2277.4, 2600.11/*, 2730.29, 503.85, 862.41, 357.44, 1640.41, 868.2, 674.57, 501.09, 2916.13, 445.37, 105.24, 704.66, 868.15, 297.27, 456.23, 31.7, 432.11, 145.05, 62.56, 134.18, 288.77*/],
        2017: [1863.61, 572.99, 615.42, 448.3, 346.44, 639.27, 190.12, 304.59, 1950.96, 2105.92, 2326.58, 396.17, 767.58, 241.49, 1361.45, 697.68, 561.27, 463.16, 2658.76, 384.53, 78.12, 496.56, 654.7, 231.51, 375.08, 27.08, 384.75, 100.54, 54.53, 97.87, 225.2],
        2016: [1603.63, 461.2, 525.67, 361.64, 291.1, 560.2, 180.83, 227.54, 1804.28, 1596.98, 1899.33, 359.6, 612.2, 165.1, 1044.9, 499.92, 479.11, 402.57, 2283.29, 336.82, 65.73, 389.97, 524.63, 194.44, 351.74, 23.17, 336.21, 88.27, 45.63, 75.54, 198.87],
      ...
      var option = {
        ...
        options: [
          ...
          }/*,
          {
            ...
            series: [
              {data: dataMap.dataAQI['2008']},
              {data: dataMap.dataPM2['2008']},
              {data: dataMap.dataO3['2008']},
              {data: dataMap.dataNO2['2008']},
              {data: dataMap.dataCO['2008']},
              {data: dataMap.dataSO2['2008']},
              {
                data: [
                  {name: '第一产业', value: dataMap.dataNO2['2008sum']},
                  {name: '第二产业', value: dataMap.dataCO['2008sum']},
                  {name: '第三产业', value: dataMap.dataSO2['2008sum']}
                ]
              }
            ]
          },
          {
            ...
            series: [
              {data: dataMap.dataAQI['2009']},
              {data: dataMap.dataPM2['2009']},
              {data: dataMap.dataO3['2009']},
              {data: dataMap.dataNO2['2009']},
              {data: dataMap.dataCO['2009']},
              {data: dataMap.dataSO2['2009']},
              {
                data: [
                  {name: '第一产业', value: dataMap.dataNO2['2009sum']},
                  {name: '第二产业', value: dataMap.dataCO['2009sum']},
                  {name: '第三产业', value: dataMap.dataSO2['2009sum']}
                ]
              }
            ]
          },
          {
            ...
            series: [
              {data: dataMap.dataAQI['2010']},
              {data: dataMap.dataPM2['2010']},
              {data: dataMap.dataO3['2010']},
              {data: dataMap.dataNO2['2010']},
              {data: dataMap.dataCO['2010']},
              {data: dataMap.dataSO2['2010']},
              {
                data: [
                  {name: '第一产业', value: dataMap.dataNO2['2010sum']},
                  {name: '第二产业', value: dataMap.dataCO['2010sum']},
                  {name: '第三产业', value: dataMap.dataSO2['2010sum']}
                ]
              }
            ]
          },
          {
            ...
            series: [
              {data: dataMap.dataAQI['2011']},
              {data: dataMap.dataPM2['2011']},
              {data: dataMap.dataO3['2011']},
              {data: dataMap.dataNO2['2011']},
              {data: dataMap.dataCO['2011']},
              {data: dataMap.dataSO2['2011']},
              {
                data: [
                  {name: '第一产业', value: dataMap.dataNO2['2011sum']},
                  {name: '第二产业', value: dataMap.dataCO['2011sum']},
                  {name: '第三产业', value: dataMap.dataSO2['2011sum']}
                ]
              }
            ]
          }*/
